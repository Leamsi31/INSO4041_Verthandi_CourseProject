        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: "url('images/index.jpg')"}} />
              <h1 id="colorlib-logo"><a href="index.html">RSEA@UPRM</a></h1>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                {<li><a href="test" >Activities</a></li> }
                ...
                <li><a href="https://github.com/Leamsi31/INSO4041_Verthandi_CourseProject" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
